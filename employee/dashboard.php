...
$share = new Share;
$sharedWith = $share->sharedWith($userId);

$share = new Share;
$sharedBy = $share->sharedBy($userId);

$recDocuments = $docs->getRecentDocuments($userId);
...
<div class="main">
  ...
  <div class="cardBox">
    ...
    <div class="cardDoc">
      <div>
        <div class="numbers"><?php echo $totalDocuments; ?></div>
  ...
  <div class="row alert-fly">
    <div class="col-md-12">
      <?php if (isset($_SESSION['user_welcome'])) : ?>
        <div class="alert alert-primary alert-fly"><?php echo $_SESSION['user_welcome'] . " " . $thisUser['firstname']; ?></div>
  ...
  <div class="row alert-fly">
    <div class="col-md-12">
      <?php if (isset($_SESSION['login_success'])) : ?>
        <div class="alert alert-primary alert-dismissible text-center alert-fly"><?php echo $_SESSION['login_success'] . " " . $thisUser['firstname']; ?></div>
      ...
      <div class="col-md-8">
        <div class="recentDocs">
          <div class="cardHeader d-flex justify-content-between align-items-center">
            ...
            <?php } else { ?>
              <a href="document.php" class="btn btn-primary d-none">View All</a>
            <?php   }
            ?>
          </div>
                ...
                <tbody>
                  <?php foreach ($recDocuments as $recdoc) : ?>
                    ...
                    <tr>
                      ...
                      <td><?php if (isset($recdoc['tag_name'])) {
                            echo $recdoc['tag_name'];
                          } else {
                            echo "Not Tagged!";
                          } ?></td>
                      <!-- <td>PDF</td> -->
                      <td>
                        <img src="uploads/<?php if (isset($thisUser['profile_image'])) {
                                            echo $thisUser['profile_image'];
                                          } else {
                                            echo $thisUser['default_image'];
                                          } ?>" alt="<?php echo $recdoc['firstname'] ?? ''; ?>" class="img-fluid" width="20" height="20">
        ...
        <div class="recentDocuments">
          <div class="cardHeader d-flex justify-content-between align-items-center">
            ...
            <?php if (!empty($sharedBy)) { ?>
              <a href="collaboration.php" class="btn btn-primary">View All</a>
            <?php } else { ?>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="imgBx me-2">
                          <img src="uploads/<?php if (isset($received['profile_image'])) {
                                              echo $received['profile_image'];
                                            } else {
                                              echo $received['default_image'];
                                            } ?>" alt="<?php echo $received['firstname'] ?? ''; ?>" class="img-fluid rounded-circle" width="30" height="30">
                        </div>
                        <div>
