    ...
    <div class="navigation">
      <ul>
        <li>
          <nav class="navbar">
            <div class="container-fluid">
              <a class="navbar-brand d-flex justify-content-evenly align-items-center" href="#">
        ...
        <li>
          <a href="collaboration.php">
            <span class="icon">
              <ion-icon name="share-outline"></ion-icon> </span>
            <span class="title">Collaboration</span>
          </a>
        </li>
        <li>
          <a href="update.php" data-updates="10" class="position-relative"">
            <span class=" icon">
