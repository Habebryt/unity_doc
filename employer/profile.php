...
<div class="main">
  ...
  $allTeam = new Team;
  $user = new User;
  $thisadmin = ($_SESSION['orgadminonline']);

  $orgId = $thisadmin['organization_id'];
  $orgEmail = $thisadmin['org_admin_email'];
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body text-center">
            <?php
            if (isset($thisUser['org_admin_image'])) {
              echo "<img src='uploads/" . $thisUser['org_admin_image'] . "' alt='Profile Image' class='img-fluid rounded-circle mb-3' style='width: 100px; height: 100px;'>";
            } else {
            ...
            <p class="card-text text-muted">Organization Admin</p>
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
              ...
              <?php echo Utilities::getDateParts($thisUser['org_date_reg']); ?>
            </li>
            <li class="list-group-item">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="country" id="country" class="form-control">
                          <option value="<?php echo isset($thisUser['org_country']) ? $thisUser['org_country'] : ''; ?>" selected><?php echo isset($thisUser['country_name']) ? $thisUser['country_name'] : ''; ?></option>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="state" id="state" class="form-control">
                          <option value="" <?php echo isset($thisUser['org_state']) ? $thisUser['org_state'] : ''; ?>"" selected><?php echo isset($thisUser['state_name']) ? $thisUser['state_name'] : ''; ?></option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <input type="hidden" name="id" value="<?php echo $thisUser['org_admin_id'] ?>">
